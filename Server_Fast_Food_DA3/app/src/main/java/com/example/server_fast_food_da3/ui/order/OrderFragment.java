package com.example.server_fast_food_da3.ui.order;
...
import com.example.server_fast_food_da3.Adapter.MyOrderAdapter;
import com.example.server_fast_food_da3.Adapter.MyShipperSelectionAdapter;
import com.example.server_fast_food_da3.Callback.IShipperLoadCallbackListener;
import com.example.server_fast_food_da3.Common.BottomSheetOrderFragment;
...
import com.example.server_fast_food_da3.EventBus.LoadOrderEvent;
...
import com.example.server_fast_food_da3.Model.TokenModel;
import com.example.server_fast_food_da3.R;
import com.example.server_fast_food_da3.Remote.IFCMService;
import com.example.server_fast_food_da3.Remote.RetrofitFCMClient;
import com.example.server_fast_food_da3.TrackingOrderActivity;
...
public class OrderFragment extends Fragment implements IShipperLoadCallbackListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        orderViewModel.getOrderMoListMutableLiveData().observe(getViewLifecycleOwner(), orderModels -> {
            if(orderModels.size() > 0 || !orderModels.isEmpty() )
            {
