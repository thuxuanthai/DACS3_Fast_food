...
import com.example.server_fast_food_da3.Adapter.MyAddonAdapter;
import com.example.server_fast_food_da3.Adapter.MySizeAdapter;
...
import com.example.server_fast_food_da3.Model.SelectSizeModel;
import com.example.server_fast_food_da3.Model.SizeModel;
import com.example.server_fast_food_da3.Model.UpdateAddonModel;
import com.example.server_fast_food_da3.Model.UpdateSizeModel;
    ...
    private void saveData() {
        if (foodEditPosition != -1) {
            ...
            FirebaseDatabase.getInstance()
                    ...
                    .addOnFailureListener(e -> Toast.makeText(com.example.server_fast_food_da3.SizeAddonEditActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show())
