...
import com.example.server_fast_food_da3.Callback.ISingleShippingOrderCallbackListener;
import com.example.server_fast_food_da3.Common.Common;
import com.example.server_fast_food_da3.Model.ShippingOrderModel;
import com.example.server_fast_food_da3.Remote.IGoogleAPI;
import com.example.server_fast_food_da3.Remote.RetrofitGoogleAPIClient;
        ...
        FirebaseDatabase.getInstance()
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        {
                            Toast.makeText(com.example.server_fast_food_da3.TrackingOrderActivity.this, "Order not found!", Toast.LENGTH_SHORT).show();
                        }
                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        Toast.makeText(com.example.server_fast_food_da3.TrackingOrderActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    public void onSingleShippingOrderLoadSuccess(ShippingOrderModel shippingOrderModel) {
        ...
        if (shipperMarker == null)
        {
            ...
            BitmapDrawable bitmapDrawable = (BitmapDrawable) ContextCompat
                    .getDrawable(com.example.server_fast_food_da3.TrackingOrderActivity.this,R.drawable.shippernew);
        ...
        try {
            ...
            compositeDisposable.add(iGoogleAPI.getDirections("driving",
                    ...
                    }, throwable -> Toast.makeText(com.example.server_fast_food_da3.TrackingOrderActivity.this, ""+throwable.getMessage(), Toast.LENGTH_SHORT).show()));
        }
        catch (Exception e)
        {
